...
<html>
	...
	<body>
		<ul class="curtains">		
			...
			<li>
				<section id="band">
					...
					<ul>
						...
						<li><a href="http://mwwildcatband.org/"><img
								src="images2/band5s.jpg" alt="" /> </a></li>
						<li><a href="http://mwwildcatband.org/"><img
								src="images2/band2s.jpg" alt="" /> </a></li>
						<li><a href="http://mwwildcatband.org/"><img
								src="images2/piano2s.jpg" alt="" /> </a></li>
						<li><a href="http://mwwildcatband.org/"><img
			...
			<li>
				<section id="trap">
					<h2>Millard West Trap Shooting</h2>
			...
			<li>
				<section id="tri-m">
					...
					<a href="http://musiced.nafme.org/tri-m/" id="tri-m-photo"><img
						src="images2/tri-m.jpg" alt="tri-m"> </a>
			...
			<li>
				<section id="connect">
					...
					<img id="connect-photo" src="images/connect.png" alt="connect1">

					<p><a href="https://www.facebook.com/tcollins195">Find me on <i class="facebook"></i></a><br>
					<a href="https://twitter.com/tcollins195">Follow me on <i class="twitter"></i></a><br>
					<a href="http://www.youtube.com/user/tcollins195">Subscribe to me on <i class="youtube"></i></a><br>					
					</p>	
